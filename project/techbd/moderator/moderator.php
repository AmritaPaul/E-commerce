...
<div id="display2">
<p style="color:green;"><b>Wellcome to <b ><?php echo $login_role;?></b>  &nbsp;&nbsp;&nbsp;&nbsp;User name is:<b> <?php echo $login_session;?></b> and  Role  :<b><?php echo $login_role;?></b></p>
<br>
...
<tr>
   ...
   <td width="10%" valign="top"><a href="../user/orderdetailsm.php?id='.$trxid.'"style="color:red;"> &nbsp;&nbsp;&nbsp;<input type="image" src="../image/button_details.png" width="60px" height="20px" "> </td></a>
