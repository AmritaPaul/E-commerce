...
$sql= "SELECT * FROM eprodinfo WHERE ep_category='electronic' ORDER BY ep_id DESC limit $page,$show";
...
<tr>
	...
	<td width="20%"><a href="../exchange/details.php?id='.$id.'" "> &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;<img src="../exchange/prodimg/'.$picpath.'" width="80px"height="80px"/></a></td>
	<td width="20%" valign="top"> &nbsp;&nbsp;&nbsp;'.$price.' </td>
	<td width="20%" valign="top"><a href="../exchange/details.php?id='.$id.'" ">&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;<input type="image" src="../image/button_details.png" width="90px" height="30px" "></td></a>
...
$sql2="SELECT * FROM eprodinfo WHERE ep_category='electronic' ORDER BY ep_id DESC ";
