...
$sql= "SELECT * FROM eprodinfo WHERE ep_category='pc hardwar' ORDER BY ep_id DESC limit $page,$show";
...
$sql2="SELECT * FROM eprodinfo WHERE ep_category='pc hardwar' ORDER BY ep_id DESC ";
