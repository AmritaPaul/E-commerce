...
<tr>
    ...
    <td width="7%" valign="top"><a href="edit_np.php?edit_id='.$id1.'" style="color:green;"><img src="../image/button_edit.png"  width="50px" height="30px" /></td></a>
    ...
    <td width="7%" valign="top"><a href="delete_np.php?delete_id='.$id1.'"style="color:red;"><input type="image" src="../image/button_delete.png" width="50px" height="30px" onclick="return del()"> </td></a>
