...
var K = document.getElementById("authentication");
...
action="insertnproduct.php" enctype="multipart/form-data" onsubmit="return validate()"> 
Add Product<br>
...
<input  type="number" id="qt" placeholder="Product Quantity" name="qt"><br>
