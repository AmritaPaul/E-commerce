...
<ul class="main-menu">
	...
	<li class="sub-menu sub-menu-1"><a href="#">Exchange </a>
      ...
      <li class="sub-menu sub-menu-1"><a href="#">Dashboard</a>
				<ul class="sub-menu-layout sub-menu-layout-1">
                    <li><a href="../admin/view.php">New Product</a></li>
					<li><a href="../user/view_a.php">Old Product</a></li>
                    <li><a href="../exchange/view_ad.php">Exchange Product</a></li>

                    <li><a href="../admin/userinfo.php">Userlist</a></li>
                    <li><a href="../user/orderview.php">Order</a></li>
                    <li><a href="../admin/slider.php">Slider</a></li>
				</ul>
			</li>  <li class="sub-menu sub-menu-1"><a href="#">Add product</a>
				<ul class="sub-menu-layout sub-menu-layout-1">
                    <li><a href="../admin/add_nproduct.php">New Product</a></li>
					
				</ul>
			</li>
             <li class="sub-menu sub-menu-1"><a href="#">Slider</a>
				<ul class="sub-menu-layout sub-menu-layout-1">
                    <li><a href="../admin/slider.php">View Slider</a></li>
                  <li><a href="../Banner/addbaner.php">Add slider</a></li>	
    ...
    <li><a href="../db/signup_ad.php">Create Account</a></li>
