...
$sql= "SELECT * FROM nprodinfo WHERE np_category='pc_hdd ' ORDER BY np_id DESC limit $page,$show";
...
$sql2="SELECT * FROM nprodinfo WHERE np_category='pc_hdd ' ORDER BY np_id DESC";
