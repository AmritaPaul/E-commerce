...
$sql= "SELECT * FROM nprodinfo WHERE np_category='antivirus' ORDER BY np_id DESC limit $page,$show";
...
<tr>
	...
	<td width="20%"><a href="../admin/details.php?id='.$id.'" "> &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;<img src="../admin/prodimg/'.$picpath.'" width="80px"height="80px"/></a></td>
...
$sql2="SELECT * FROM nprodinfo WHERE np_category='antivirus' ORDER BY np_id DESC";
