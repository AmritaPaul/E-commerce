...
$sql= "SELECT * FROM nprodinfo WHERE np_category='adobe' ORDER BY np_id DESC limit $page,$show";
...
$sql2="SELECT * FROM nprodinfo WHERE np_category='adobe' ORDER BY np_id DESC";
