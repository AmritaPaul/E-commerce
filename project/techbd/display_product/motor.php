...
$sql= "SELECT * FROM nprodinfo WHERE np_category='motor ' ORDER BY np_id DESC limit $page,$show";
...
$sql2="SELECT * FROM nprodinfo WHERE np_category='motor ' ORDER BY np_id DESC ";
