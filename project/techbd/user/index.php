...
mysql_select_db("techbd");

?>
<?php

$res = mysql_query("SELECT * FROM `banner` ORDER BY `banner`.`b_id` ASC");
...
Price:'.$price.'Tk
<table><tr><td><a href="user/cart.php?id='.$id.'" ><img src="image/green-add-to-cart-button-hi.png" width="70px" height="30px" /></td></a></td><td><a href="admin/details.php?id='.$id.'" style="color:green;"><img src="image/Details-button.png" width="80px" height="30px" /></td></a></tr></table></div>';?>
    <?php
}
...
{
 $opage=$_POST["opage"];
 $opage=($opage*$oshow)-$oshow;//counting for 9 image is displayed in one page
}
$ores = mysql_query("SELECT * FROM oprodinfo ORDER BY op_id DESC limit $opage,$oshow");//set limit to display 9 images
...
$ores1 = mysql_query("SELECT * FROM oprodinfo ORDER BY op_id DESC");
$ocount=mysql_num_rows($ores1);//use for count how many images in database
$oa=$ocount/$oshow;
$oa=ceil($oa);//ceil function is used to round up figure
echo "<br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br>";
?>
...
$eres = mysql_query("SELECT * FROM eprodinfo ORDER BY ep_id DESC limit $epage,$eshow");//set limit to display 9 images
...
$eres1 = mysql_query("SELECT * FROM eprodinfo ORDER BY ep_id DESC");
$ecount=mysql_num_rows($eres1);//use for count how many images in database
$ea=$ecount/$eshow;
