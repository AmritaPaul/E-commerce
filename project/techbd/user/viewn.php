...
$sql1='SELECT * FROM nprodinfo   ORDER BY np_id DESC LIMIT ' . $this_page_first_result . ',' .  $results_per_page;
...
<tr>
	...
	<td width="20%"> &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;<img src="../admin/'.$picpath.'" width="60%"height="20%"/></td>
...
for ($page=1;$page<=$number_of_pages;$page++) {
  echo '<a href="viewn.php?page=' . $page . '">' . $page . '</a> ';
}
echo'Next Page>>';
?>
