...
<input type="number" id="contact" placeholder="Contact" name="contact"><br>
<input type="number" id="pprice" placeholder="Product Price" name="pprice"><br>
 Condition:&nbsp&nbsp;&nbsp;&nbsp;&nbsp;<select name="pcondition" id="pcondition">
<option value="">Choose Condition</option>
<option value="old">Old</option>
<option value="new">New</option>
</select>
 Authentication:<select name="authentication" id="authentication" style="width:100px">
<option value="">Choose Condition</option>
<option value="Copy">Copy</option>
<option value="Original">Original</option>
</select><br>
 Image:<input type="file" name="file_img" id="file_img" ><br>
Category:&nbsp&nbsp;&nbsp;&nbsp;&nbsp; <select name="category" id="category">
...
<p>Product Description</p> <textarea name="pdesc" id="pdesc"  placeholder="Description" "rows="20" cols="55"></textarea>


    <div><input type="submit" name="btn_upload" button id="addnewprouct" value="Add product"   ></button> </div>
    </form>
</div>
