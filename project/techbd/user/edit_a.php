...
<tr><td>Product Price </td><td><input type="text" id="pprice" value='.$pprice.' name="pprice"></td></tr>
<p><img src="../user/'.$picpath.'" height="150" width="150" /></p>
<tr><td>Select Image </td><td><input type="file" name="file_img" id="file_img" accept="image/*" ></td></tr>
...
<tr><td>Product Description</td><td> <textarea name="pdesc" id="pdesc" value='.$pdesc.' "rows="3" cols="40"></textarea></td></tr>
