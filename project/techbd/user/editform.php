...
<form method="post" enctype="multipart/form-data">
    ...
    <tr>
        ...
        <td><input type="text" name="pname" value="<?php echo $op_name; ?>" required /></td>
    </tr>
    <tr><td>Product Condition:<td><input type="text" id="pcondition" value='<?php echo $op_condition; ?>' name="op_condition"></td></tr>
    <tr>
    	<td><label>Product Brand</label></td>
        <td><input type="text" name="brand" value="<?php echo $op_brand; ?>" required /></td>
    </tr>
    ...
    <tr><td>Product Price </td><td><input type="text" id="pprice" value='<?php echo $op_price; ?>' name="op_price"></td></tr>
    <tr>
    	<td><label>Product Img.</label></td>
        <td>
        	<p><img src="prodimg/<?php echo $p_image; ?>" height="150" width="150" /></p>
        	<input type="file" name="p_image" accept="image/*" />
        </td>
    </tr>
    
    <tr>
        <td colspan="2"><button type="submit" name="btn_save_updates">
        <span></span> Update
        </button>
        
        <a href="file:///C|/xampp/htdocs/lict/emp/index.php"> <span></span> cancel </a>
...
<hr />
<b>How to pay </b> &nbsp;&nbsp;&nbsp;&nbsp Cash on delevery <img src="file:///C|/xampp/htdocs/lict/emp/image/bkash_logo.png" id="pay" width="30px" height="40px" />
 <img src="file:///C|/xampp/htdocs/lict/emp/image/120716173707_UKashLogo2.jpg" id="pay" width="40px" height="30px" />
<br /><hr />
