...
<ul class="main-menu">
    ...
    <li><a href="#">Sell On Techbd</a></li>
	<li><a href="file:///H|/techbd/about.html">About</a></li>
    <li><a href="file:///H|/techbd/about.html">Sign Up</a></li>
    <li><a href="file:///H|/techbd/about.html">Login</a></li>
...
$sql = "SELECT * FROM oprodinfo  WHERE op_category='Mobile' ORDER BY op_id DESC ";
...
<tr>
	...
	<td width="20%"> &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;<img src="../user/'.$picpath.'" width="60%"height="60%"/></td>
