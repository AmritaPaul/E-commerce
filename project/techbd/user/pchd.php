...
$sql="SELECT * FROM oprodinfo WHERE op_category='pc hardwar' ORDER BY op_id DESC limit $page,$show";
...
$sql2="SELECT * FROM oprodinfo WHERE op_category='pc hardwar' ORDER BY op_id DESC";
