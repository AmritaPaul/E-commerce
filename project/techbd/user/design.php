...
$res = mysql_query("SELECT * FROM nprodinfo  WHERE np_category='antivirus'     limit $page,$show");
...
<tr>
	...
	<td width="20%"> &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;<img src="../admin/prodimg/'.$picpath.'" width="80px"height="80px"/></td>
...
$res1 = mysql_query("SELECT * FROM nprodinfo  WHERE np_category='antivirus'   ");
...
{
 ?>
    <input type="submit" value="<?php echo $b;?>" name="epage">
    <?php
}?>
</div>
<div id="footer1">
