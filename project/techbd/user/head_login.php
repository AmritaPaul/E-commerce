...
<div id="headdown">
    ...
    <div class="demo-content">
		<div id="notification-header">
			   ...
			   <button id="notification-icon" name="button" onClick="myFunction()" class="dropbtn"><span id="notification-count"><?php if($count>0) { echo $count; } ?></span><img src="../image/blue-sms-icon-hi.png" style="width:40px; height:40px; top:30px" /></button>
