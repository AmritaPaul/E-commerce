...
<tr>
	...
	<td width="20%" valign="top"> &nbsp;&nbsp;&nbsp;'.$status.' </td>
   <td width="10%" valign="top"><a href="actiondm.php?id='.$id.'"style="color:red;"> &nbsp;&nbsp;&nbsp;<input type="image" src="../image/button_action.png" width="60px" height="20px" "> </td></a>
   <td width="10%" valign="top"><a href="orderdetailsm.php?id='.$id.'"style="color:red;"> &nbsp;&nbsp;&nbsp;<input type="image" src="../image/button_details.png" width="60px" height="20px" "> </td></a>
   <td width="10%" valign="top"><a href="massagem.php?id='.$id.'"style="color:red;"> &nbsp;&nbsp;&nbsp;<input type="image" src="../image/button_massage.png" width="60px" height="20px" "> </td></a>
   <td width="10%" valign="top"><a href="deleteorm.php?id='.$id.'"style="color:red;"> &nbsp;&nbsp;&nbsp;<input type="image" src="../image/button_delete.png" width="60px" height="20px" onclick="return del()"> </td></a>
