...
$sql="SELECT * FROM oprodinfo WHERE op_category='other' ORDER BY op_id DESC limit $page,$show";
...
$sql2="SELECT * FROM oprodinfo WHERE op_category='other' ORDER BY op_id DESC";
